...
def do_actions(player1, player2, character1, character2, action1, action2):
	debug = True
	...
	def calculate_action(action1, action2, character1, character2, player1, player2):
		...
		return [player1, player2, character1, character2]
	...
	if action1[5] > action2[5]:
		...
		set_results(calculate_action(action1, action2, character1, character2, player1, player2))
		if debug: print()
		if debug: print("Player 2 attacks next!")
		set_results(reorder(calculate_action(action2, action1, character2, character1, player2, player1)))
